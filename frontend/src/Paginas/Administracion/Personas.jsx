...
const Persona = () => {
  ...
  const [idPersonaEditar, setidPersonaEditar] = useState(null);
  ...
  return (
    <>
              ...
              <tr key={persona.id}>
                ...
                <Td>
                  <div className='d-flex gap-2'>
                    <button type="button" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalEditPersona" title='Editar' onClick={() => { setidPersonaEditar(persona.id); }}>
      ...
      <ModalEditPersona getAllPersonas={getAllPersonas} id={idPersonaEditar} />
    </>
  )
}
