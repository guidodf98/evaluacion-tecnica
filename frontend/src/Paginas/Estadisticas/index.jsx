      ...
      <div className='container'>
        {estadisticasCursos.length === 0 ? (
          <div className="container pt-5">
            ...
            Por favor, cree nuevos cursos para poder ver las estadísticas.
            </div>
          </div>
        ) : (
          estadisticasCursos.map((curso, index) => (
            <div className="px-4 py-5 text-center border-bottom" key={index}>
